...
$(`<div class="uzr fl corner borderg mm bid1camh6so110" style="border-radius:5px;margin-bottom:-2px;width:99.5%;padding:0px; background-color:white;">
      ...
      <div class="uzr fl" style="padding:0px;width:80%">
        <div style="padding:0px;width:100%;" class="fl">
          ...
          <span style="padding: 1px 8px; margin-top: 2px; display: block; max-width: 82%; border-radius: 3px; color: rgb(250, 250, 250); background-color: rgb(130, 130, 130);" class="corner nosel u-topic dots fl hand">  ❰أإسہٰٰ۫ـيآدهہٰٰ۫ــٰཻ℘ـہٰٰ۫ہٰٰ۫ـٰٰ۫م❱ ●・:skull:</span>
        </div>
        <br>
        <div style="padding:0px; width:100%;" class=" u-msg   break  fl">نعزي الأمة الأسلامية وصاحب العصر والزمان الإمام المهدي عجل الله فرجه الشريف بأستشهاد جده الأمام الکاظم عليه السلام&nbsp;</div>
      </div>
&nbsp;<br />
&nbsp;</div>
      </div>
